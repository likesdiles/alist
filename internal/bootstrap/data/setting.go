...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "党委会、校长办公会线上平台", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "欢迎访问党委会、校长办公会线上平台", Type: conf.TypeText, Group: model.SITE},
